...
AND tbl_job_application.app_status = 2
...
<div id="nav">
    ...
    <ul>
     ...
     <li><a href="RejApp.php" class="active" href="#rejected">Rejected</a></li>
     <li><a href="PenApp.php">Pending</a></li>
    </ul>
</div>
<main id="main"> 

    <h1 class="jobname" style="font-size: 25pt; width: 78%; text-align: center;">Rejected job application</h1>
    <br>
