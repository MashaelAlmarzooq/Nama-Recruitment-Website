...
<div class="row">
    ...
    <div class="searchArea">
        ...
        <li><a href="jobsearch2.php">For a job</a></li>
    </ul>
    </div>
    ...
    <div class="PostedJobs">
        <h1 class="title">
        <a href="postedjobsseeker.php" style="color: #647397">Posted Jobs</a></h1>
     ...
     <br>
                <br>
                <button class="apply" onclick="window.location.href='postedjobsseeker.php';">Details</button>
                </div>
                <?php } ?>
    ...
    <div class="notification">
                <h3 class="title">
            <a class="jobname" href="job_sekeer_advice.php">Advices</a></h3>
        ...
        <div class="notificationContent">
         ...
         <h4 class="jobname"><?php echo $rec['advice_title']; ?></h4>
             ...
             <a href="job_sekeer_advice.php" class="wrap">Read more</a>
             <br><br>
             <?php $i++; } ?>
            </marquee>
